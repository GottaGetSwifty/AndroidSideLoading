 ...
 */
public class LoadManager implements TypeChoosingFragment.TypeChosenListener {
    ...
    public LoadManager(AppCompatActivity activity, SideLoadInformation sideLoadInformation, LoadManagerListener listener) {
